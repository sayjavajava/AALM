...
/**
  ...
  * for MLS
  */
class MLS_CompanyConfig extends eCash_Config
{
	protected function init()
 	{
		//define('CUSTOMER_LIB', BASE_DIR . "customer_lib/mls/");

		/**
		 * ACH Related
		 */
		$this->configVariables['ACH_BATCH_LOGIN'] = 'tts_atlas';
		$this->configVariables['ACH_BATCH_PASS'] = 'v6BAh6PR';
		$this->configVariables['ACH_REPORT_LOGIN'] = 'tts_atlas';
		$this->configVariables['ACH_REPORT_PASS'] = 'v6BAh6PR';
		...
		$this->configVariables['LIVE']['ACH_BATCH_LOGIN'] = 'tts_atlas';
		$this->configVariables['LIVE']['ACH_BATCH_PASS'] = 'v6BAh6PR';
		$this->configVariables['LIVE']['ACH_REPORT_LOGIN'] = 'tts_atlas';
		$this->configVariables['LIVE']['ACH_REPORT_PASS'] = 'v6BAh6PR';
		...
		// Condor 4
		$this->configVariables['CONDOR_SERVER'] = 'prpc://multiloansource:mlsc0nd0r@condor-staging.atlas-lms.com/condor_api.php'; //no RC or below avail :(
		$this->configVariables['LIVE']['CONDOR_SERVER'] = 'prpc://multiloansource:mlsc0nd0r@condor-staging.atlas-lms.com/condor_api.php';

		// Documents Related
		$this->configVariables['COMPANY_ADDR'] = '790 West Sam Houston Parkway North, Suite 202, Houston, Texas 77024';
		//$this->configVariables['COMPANY_ADDR_CITY'] = 'Houston';
		//$this->configVariables['COMPANY_ADDR_STATE'] = 'TX';
		//$this->configVariables['COMPANY_ADDR_STREET'] = '790 West Sam Houston Parkway North';
		...
		//$this->configVariables['COMPANY_ADDR_ZIP'] = '77024';
		...
		$this->configVariables['COMPANY_NAME_LEGAL'] = 'Clear Lake Holdings';
		...
		$this->configVariables['LIVE']['COMPANY_SITE'] = 'www.atlas-lms.com';
		$this->configVariables['COMPANY_DOMAIN'] = 'atlas-lms.com';
		...
		$this->configVariables['LIVE']['REACT_URL'] = 'https://staging.multiloansource.net';
		...
		$this->configVariables['LIVE']['NEW_APP_SITE'] = 'https://staging.multiloansource.net';
		...
		$this->configVariables['LIVE']['ESIG_URL'] = 'https://staging.multiloansource.net';
