	...
	protected function init()
 	{
		...
		// Condor 4
		$this->configVariables['CONDOR_SERVER'] = 'prpc://multiloansource:mlsc0nd0r@rc.condor.4.edataserver.com/condor_api.php';
		...
		$this->configVariables['COMPANY_LOGO_LARGE'] = 'http://imagedataserver.com/SHARED/live/themes/IPS/skins/nms/ic/staging.multiloansource.com/media/image/mls_small.gif';
		$this->configVariables['COMPANY_LOGO_SMALL'] = 'http://imagedataserver.com/SHARED/live/themes/IPS/skins/nms/ic/staging.multiloansource.com/media/image/mls_small.gif';
		...
		$this->configVariables['RC']['COMPANY_SITE'] = 'rc.staging.multiloansource.net';
		$this->configVariables['LIVE']['COMPANY_SITE'] = 'staging.multiloansource.net';
		$this->configVariables['COMPANY_DOMAIN'] = 'staging.multiloansource.net';
		...
		$this->configVariables['LIVE']['NEW_APP_SITE'] = 'http://staging.multiloansource.net';
