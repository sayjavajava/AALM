	...
	protected function init()
 	{
		...
		$this->configVariables['CRA_DB_HOST'] = 'writer.mysql.atlas-lms.com';
		$this->configVariables['CRA_DB_NAME'] = 'ldb_mls';
		$this->configVariables['CRA_DB_USER'] = 'ecash';
		$this->configVariables['CRA_DB_PASS'] = 'Hook6Zoh';
		$this->configVariables['CRA_DB_PORT'] = 3306;
