 ...
 * Execution Mode
 */
define('EXECUTION_MODE', 'QA_AUTOMATED');
	...
	protected function init()
 	{
		...
		$this->configVariables['REACT_SOAP_URL'] = 'http://aqa.bfw.1.edataserver.com/cm_soap.php?wsdl';
		$this->configVariables['REACT_SOAP_KEY'] = '13eb55c3098ad6a6e18a3aadd90d1304';
		$this->configVariables['ECASH_APP_REACT_PROMOID'] = 27713;
		$this->configVariables['VAPI_PRPC_URL'] = 'http://vendor-api-commercial.aqa.tss/index.php';
		
                $this->configVariables['APP_SERVICE_USER'] = 'aalm_auto';
                $this->configVariables['APP_SERVICE_PASS'] = 'changeme';
